   ...
   <main class="flex-grow">
    <section class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="w-full max-w-[1440px] px-4 md:px-10 py-6 md:py-10 flex flex-col gap-8">
                ...
                <!-- Pagination -->
                <div class="mt-12 flex justify-center border-t border-border-color dark:border-gray-800 pt-8 gap-4 w-full">
  ...
  <script>
        ...
        function fetchCategories(page = 1) {
            ...
            function renderPagination(pagination) {
                ...
                html += `
                    <button class="pagination-btn flex items-center justify-center size-9 rounded hover:bg-[#f3e7eb] dark:hover:bg-gray-800 text-text-main dark:text-white disabled:opacity-50 ${prevDisabled}" 
                            onclick="fetchCategories(${current_page - 1})" ${prevDisabled}>
                ...
                if (startPage > 1) {
                    html += `
                        <button class="pagination-btn flex items-center justify-center size-9 rounded hover:bg-[#f3e7eb] dark:hover:bg-gray-800 text-text-main dark:text-white font-medium text-sm transition-colors" 
                    ...
                    if (startPage > 2) {
                        html += `<span class="flex items-center justify-center size-9 text-text-secondary dark:text-gray-500">...</span>`;
                    }
                }
                ...
                for (let i = startPage; i <= endPage; i++) {
                    ...
                    const buttonClass = isActive 
                        ...
                        : 'hover:bg-[#f3e7eb] dark:hover:bg-gray-800 text-text-main dark:text-white font-medium text-sm transition-colors';
                    
                    html += `
                        <button class="pagination-btn flex items-center justify-center size-9 rounded ${buttonClass}" 
                ...
                if (endPage < total_pages) {
                    ...
                    html += `
                        <button class="pagination-btn flex items-center justify-center size-9 rounded hover:bg-[#f3e7eb] dark:hover:bg-gray-800 text-text-main dark:text-white font-medium text-sm transition-colors" 
                                onclick="fetchCategories(${total_pages})">
                            ${total_pages}
                        </button>
                    `;
                }
                ...
                html += `
                    <button class="pagination-btn flex items-center justify-center size-9 rounded hover:bg-[#f3e7eb] dark:hover:bg-gray-800 text-text-main dark:text-white transition-colors ${nextDisabled}" 
                            onclick="fetchCategories(${current_page + 1})" ${nextDisabled}>
